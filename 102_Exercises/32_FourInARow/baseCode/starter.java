...
class starter {
 ...
 //			for (int o =0; o > 1; i++) {
 //				if ((board[i][o].equals(board[i+1][o]) && board[i][o].equals(board[i+2][o]) && board[i][o].equals(board[i+3][o])) || (board[i+1][o].equals(board[i+2][o]) && board[i+1][o].equals(board[i+3][o]) && board[i+1][o].equals(board[i+4][o])) || (board[i][o].equals(board[i+3][o]) && board[i][o].equals(board[i+4][o]) && board[i+3][o].equals(board[i+5][o]) && board[i+3][o].equals(board[i+6][o]))){
 //					if (board[2][o].equals("A")) {
 //						return 1;
 //					}
 //					else {
 //						return 2;
